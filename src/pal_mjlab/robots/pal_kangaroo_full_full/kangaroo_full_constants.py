...
INIT_STATE = EntityCfg.InitialStateCfg(
  ...
  joint_pos={
    ...
    "(left_hip_xy_motor_l|right_hip_xy_motor_r)": -0.0076,
    "(leg_left_2_actuator|leg_right_3_actuator)": 0.0045,
    ".*_hip_xy_bracket_r": 0.0003,
    "(left_hip_xy_motor_r|right_hip_xy_motor_l)": 0.0024,
    "(leg_left_3_actuator|leg_right_2_actuator)": 0.0017,
