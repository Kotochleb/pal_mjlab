pal_mjlab Documentation
========================

``pal_mjlab`` provides PAL Robotics' robots and training tasks on top of
`mjlab <https://github.com/mujocolab/mjlab>`_.
...
.. toctree::
   ...
   kangaroo/tasks/task_box_lifting